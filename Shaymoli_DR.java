...
public class Shaymoli_DR extends JFrame implements ActionListener,MouseListener {
    ...
    Shaymoli_DR() {
        ...
        bn.setText("Shaymoli");
        bn.setBounds(50, 200, 140, 40);
        bn.setForeground(Color.BLACK);
        bn.setFont(f2);
        c.add(bn);
        JLabel bdn = new JLabel();
        bdn.setText("Driver Name : RONI");
        ...
        st.setText("Starting Time : 8:00 Pm");
        st.setBounds(50, 320, 400, 40);
        st.setForeground(Color.BLACK);
        st.setFont(f);
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : CITYGATE");
        e.setBounds(50, 360, 450, 40);
        e.setForeground(Color.BLACK);
        e.setFont(f);
        c.add(e);
        JLabel et = new JLabel();
        et.setText("Ending Time : 1:00 Am");
        et.setBounds(50, 400, 400, 40);
        et.setForeground(Color.BLACK);
        et.setFont(f);
        c.add(et);
        JLabel C = new JLabel();
        C.setText("Contact : 01898246182");
