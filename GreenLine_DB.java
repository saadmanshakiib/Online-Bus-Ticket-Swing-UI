...
public class GreenLine_DB extends JFrame implements ActionListener,MouseListener {
    ...
    GreenLine_DB() {
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : Bou-Bazar ");
    ...
    {
        GreenLine_DB p = new GreenLine_DB();
        p.setVisible(true);
    }
