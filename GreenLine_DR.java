...
public class GreenLine_DR extends JFrame implements ActionListener,MouseListener {
    ...
    GreenLine_DR() {
        ...
        et.setText("Ending Time : 1:00 Pm");
        et.setBounds(50, 400, 400, 40);
        et.setForeground(Color.BLACK);
        et.setFont(f);
        c.add(et);
        JLabel C = new JLabel();
        C.setText("Contact : 01678924121");
    ...
    {
        GreenLine_DR p = new GreenLine_DR();
        p.setVisible(true);
    }
