...
public class DhakaKhulna extends JFrame implements ActionListener,MouseListener {
    DhakaKhulna(){
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setSize(1000,800);
        this.setLocationRelativeTo(null);
        this.setTitle("DhakaKhulna");
        ...
        JButton back = new JButton();
            ...
            Greenline_route.setText("Dhaka -> Khulna");
            ...
            details.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent a){
                        GreenLine_DK g = new GreenLine_DK();
                        g.setVisible(true);
                    setVisible(false);
                }
            });//clear
        ...
        hanif_route.setText("Dhaka -> Khulna");
        ...
        ena_route.setText("Dhaka -> Khulna");
        ...
        shaymoli_route.setText("Dhaka -> Khulna");
    ...
    public static void main(String[] a){
        DhakaKhulna dc = new DhakaKhulna();
        dc.setVisible(true);
    }
