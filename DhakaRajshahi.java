...
public class DhakaRajshahi extends JFrame implements ActionListener,MouseListener {
    DhakaRajshahi(){
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setSize(1000,800);
        this.setLocationRelativeTo(null);
        this.setTitle("DhakaRajshahi");
        ...
        JButton back = new JButton();
            ...
            Greenline_route.setText("Dhaka -> Rajshahi");
            ...
            details.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent a){
                        GreenLine_DR g = new GreenLine_DR();
                        g.setVisible(true);
                    setVisible(false);
                }
            });//clear
        ...
        hanif.setText("HANIF");
        hanif.setBounds(120,280,80,40);
        hanif.setFont(f3);
        hanif.setForeground(Color.BLACK);
        c.add(hanif);
        JLabel hanif_route = new JLabel();
        hanif_route.setText("Dhaka -> Rajshahi");
        ...
        SA.setText("SA PARIBAHAN");
        SA.setBounds(50,360,220,40);
        SA.setFont(f3);
        SA.setForeground(Color.BLACK);
        c.add(SA);
        JLabel sa_route = new JLabel();
        sa_route.setText("Dhaka -> Rajshahi");
        ...
        u_route.setText("Dhaka -> Rajshahi");
        ...
        ena_route.setText("Dhaka -> Rajshahi");
        ...
        shaymoli_route.setText("Dhaka -> Rajshahi");
    ...
    public static void main(String[] a){
        DhakaRajshahi dc = new DhakaRajshahi();
        dc.setVisible(true);
    }
