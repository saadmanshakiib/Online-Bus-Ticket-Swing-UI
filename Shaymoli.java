...
public class Shaymoli extends JFrame implements ActionListener,MouseListener {
    ...
    Shaymoli() {
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : Jamalkhan");
