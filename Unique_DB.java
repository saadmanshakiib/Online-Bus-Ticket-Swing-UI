...
public class Unique_DB extends JFrame implements ActionListener,MouseListener {
    ...
    Unique_DB() {
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : Sabgram");
        e.setBounds(50, 360, 430, 40);
        e.setForeground(Color.BLACK);
        e.setFont(f);
        c.add(e);
        JLabel et = new JLabel();
        et.setText("Ending Time : 9:00 Am");
