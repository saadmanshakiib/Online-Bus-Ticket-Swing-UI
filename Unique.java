...
public class Unique extends JFrame implements ActionListener,MouseListener {
    ...
    Unique() {
        ...
        back.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                DhakaChittagong q = new DhakaChittagong();
                q.setVisible(true);
                setVisible(false);
            }
        });
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : NAVY GATE");
