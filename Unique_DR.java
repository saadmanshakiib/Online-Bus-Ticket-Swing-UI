...
public class Unique_DR extends JFrame implements ActionListener,MouseListener {
    ...
    Unique_DR() {
        ...
        back.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                DhakaRajshahi q = new DhakaRajshahi();
                q.setVisible(true);
                setVisible(false);
            }
        });
        ...
        bn.setText("UNIQUE");
        bn.setBounds(50, 200, 120, 40);
        bn.setForeground(Color.BLACK);
        bn.setFont(f2);
        c.add(bn);
        JLabel bdn = new JLabel();
        bdn.setText("Driver Name : SAMIUL");
        bdn.setBounds(50, 240, 400, 40);
        bdn.setForeground(Color.BLACK);
        bdn.setFont(f);
        c.add(bdn);
        JLabel s = new JLabel();
        s.setText("Starting Point : JATRABARI");
        s.setBounds(50, 280, 420, 40);
        s.setForeground(Color.BLACK);
        s.setFont(f);
        c.add(s);
        JLabel st = new JLabel();
        st.setText("Starting Time : 3:00 Pm");
        st.setBounds(50, 320, 400, 40);
        st.setForeground(Color.BLACK);
        st.setFont(f);
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : CITY GATE");
        e.setBounds(50, 360, 430, 40);
        e.setForeground(Color.BLACK);
        e.setFont(f);
        c.add(e);
        JLabel et = new JLabel();
        et.setText("Ending Time : 11:00 Am");
        et.setBounds(50, 400, 400, 40);
        et.setForeground(Color.BLACK);
        et.setFont(f);
        c.add(et);
        JLabel C = new JLabel();
        C.setText("Contact : 01765423498");
