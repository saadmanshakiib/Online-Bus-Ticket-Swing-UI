...
public class DhakaChittagong extends JFrame implements ActionListener,MouseListener {
    DhakaChittagong(){
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setSize(1000,800);
        this.setLocationRelativeTo(null);
        this.setTitle("DhakaChittagong");
        ...
        JButton back = new JButton();
            ...
            Greenline_route.setText("Dhaka -> Chittagong");
        ...
        hanif_route.setText("Dhaka -> Chittagong");
        ...
        sa_route.setText("Dhaka -> Chittagong");
        ...
        u_route.setText("Dhaka -> Chittagong");
        ...
        ena_route.setText("Dhaka -> Chittagong");
        ...
        shaymoli_route.setText("Dhaka -> Chittagong");
