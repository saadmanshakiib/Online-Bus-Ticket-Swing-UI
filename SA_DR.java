...
public class SA_DR extends JFrame implements ActionListener,MouseListener {
    ...
    SA_DR() {
        ...
        et.setText("Ending Time : 6:00 Pm");
        et.setBounds(50, 400, 400, 40);
        et.setForeground(Color.BLACK);
        et.setFont(f);
        c.add(et);
        JLabel C = new JLabel();
        C.setText("Contact : 01864590221");
