...
public class Shaymoli_DK extends JFrame implements ActionListener,MouseListener {
    ...
    Shaymoli_DK() {
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : KHULNAGATE");
