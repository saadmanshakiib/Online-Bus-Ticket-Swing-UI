...
public class Shaymoli_DB extends JFrame implements ActionListener,MouseListener {
    ...
    Shaymoli_DB() {
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : Shahjahanpur");
