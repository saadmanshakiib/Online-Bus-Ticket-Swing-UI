...
public class SFA extends JFrame implements ActionListener,MouseListener {
    ...
    SFA() {
        ...
        bn.setText("Shah Fateh Ali");
        bn.setBounds(50, 200, 400, 40);
        bn.setForeground(Color.BLACK);
        bn.setFont(f2);
        c.add(bn);
        JLabel bdn = new JLabel();
        bdn.setText("Driver Name : Rahman");
        ...
        c.add(st);
        JLabel e = new JLabel();
        e.setText("Ending Point : Charmatha ");
